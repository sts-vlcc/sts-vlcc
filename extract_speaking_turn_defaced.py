...
'''
Run example
python extract_speaking_turn_defaced.py --csv /home/admin-guest/Documents/multimodal-ml/FrozenBiLM_clip/datasets/SIQ2/vid_defaced_contextualized_features/vid_defaced_transcript_paths.csv
'''
