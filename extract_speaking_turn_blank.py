...
'''
Run example
python extract_speaking_turn_blank.py --csv /home/admin-guest/Documents/multimodal-ml/FrozenBiLM_clip/datasets/SIQ2/vid_blank_contextualized_features/vid_blank_transcript_paths.csv
'''
