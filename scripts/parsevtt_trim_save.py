...
if __name__ == "__main__":
    ...
    parser.add_argument("vtt_output_folder", help="Path to the folder where trimmed VTT files will be saved.")
    ...
    if not os.path.exists(args.vtt_output_folder):  # Make sure the VTT output folder exists
        os.makedirs(args.vtt_output_folder)

    merged_data = process_folder(args.input_folder, args.output_folder, args.vtt_output_folder)
