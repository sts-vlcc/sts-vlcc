...
def main():
    ...
    temp1 = get_referenced_vid_names_from_json(args.json_file1)
    referenced_vid_names.update(temp1)
    print(len(temp1))

    temp2 = get_referenced_vid_names_from_json(args.json_file2)
    referenced_vid_names.update(temp2)
    print(len(temp2))

    temp3 = get_referenced_vid_names_from_json(args.json_file3)
    referenced_vid_names.update(temp3)
    print(len(temp3))
    print("sum: ",len(temp1) + len(temp2) + len(temp3))

    # Print the repeated elements between each pair
    print("Elements in both temp1 and temp2:",len(temp1&temp2), temp1 & temp2, )
    print("Elements in both temp2 and temp3:", len(temp2&temp3), temp2 & temp3)
    print("Elements in both temp1 and temp3:", len(temp1&temp3), temp1 & temp3)

    all_vtt_files = get_all_files(args.vtt_folder,".vtt")
    all_mp4_files = get_all_files(args.mp4_folder,".mp4")

    print("reference len: ",len(referenced_vid_names))
